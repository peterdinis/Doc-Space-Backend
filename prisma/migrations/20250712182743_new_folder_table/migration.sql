...
INSERT INTO "new_Document" ("content", "createdAt", "id", "inTrash", "ownerId", "status", "title", "updatedAt") SELECT "content", "createdAt", "id", "inTrash", "ownerId", "status", "title", "updatedAt" FROM "Document";
DROP TABLE "Document";
